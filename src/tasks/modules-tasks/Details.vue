    ...
    <div v-if="$parent.permissions.action_0 &&($parent.method=='details')">
        ...
        <div class="card d-print-none mb-2" v-if="'id' in $parent.item">
          <div class="card-header">
            <div >{{$systemFunctions.getLabel('label_details')}} ::{{$parent.item['name_'+this.$systemFunctions.getLanguage()]}}</div>            
          </div>
          <div class="card-body col-md-8">
              <div class="row mb-2" v-for="(language,i) in $systemFunctions.language_available" :key="'language_'+i">
                <div class="col-4">
                    <label class="font-weight-bold float-right">{{$systemFunctions.getLabel('label_name_'+language)}}</label>
                </div>
                <div class="col-lg-4 col-8">
                    {{$parent.item['name_'+language]}}                    
                </div>
              </div>          
              <div class="row mb-2">
                <div class="col-4">
                    <label class="font-weight-bold float-right">{{$systemFunctions.getLabel('label_module_task_type')}}</label>
                </div>
                <div class="col-lg-4 col-8">
                    {{$parent.item.type}}                    
                </div>
              ...
              <div class="row mb-2">
                <div class="col-4">
                    <label class="font-weight-bold float-right">{{$systemFunctions.getLabel('label_created_by')}}</label>
                </div>
                <div class="col-lg-4 col-8">
                    {{$parent.item.created_by}} 
                </div>
              </div> 
              <div class="row mb-2">
                <div class="col-4">
              ...
              <div class="row mb-2">
                <div class="col-4">
                    <label class="font-weight-bold float-right">{{$systemFunctions.getLabel('label_created_time')}}</label>
                </div>
                <div class="col-lg-4 col-8">
                    {{$systemFunctions.displayTime($parent.item.created_at)}}
                </div>
              </div>
          </div>          
        </div>  
